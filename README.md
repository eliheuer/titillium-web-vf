...
A few dependancies are requiered for the build script to work, from the root directory of this repo run: `pip install -r requirements.txt`. For more information on the requirements, please see the source documentation [here](https://github.com/eliheuer/titillium-web-vf/tree/master/source).
