...
* :fire: **FAIL** Unmatched family name in font: TTF has "TitilliumWeb" while METADATA.pb has "Titillium Web" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "TitilliumWeb-ExtraLight" while METADATA.pb has "Titillium-Web". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "TitilliumWeb ExtraLight" while METADATA.pb has "Titillium Web". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font filename="TitilliumWeb-Roman-VF.ttf" does not match post_script_name="Titillium-Web".
...
* :fire: **FAIL** METADATA.pb postScriptName ("Titillium-Web") does not match correct font name format ("TitilliumWeb ExtraLight").
...
But instead we have got: 'Copyright (c) 2009-2011 by Accademia di Belle Arti di Urbino and students of MA course of Visual design. Some rights reserved.'
* :bread: **PASS** Name table entry: Copyright field 'Copyright 2017 The Cairo Project Authors (https://github.com/Gue3bara/Cairo)' matches canonical pattern.
...
* :fire: **FAIL** METADATA.pb: filename field ("TitilliumWeb-Roman-VF.ttf") does not match canonical name "TitilliumWeb-ExtraLight.ttf".
...
* :fire: **FAIL** METADATA.pb: Fullname ("Titillium Web") does not match name table entry "TitilliumWeb ExtraLight" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("Titillium-Web") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Copyright field for this font on METADATA.pb ('Copyright (c) 2009-2011 by Accademia di Belle Arti di Urbino and students of MA course of Visual design. Some rights reserved.') differs from a copyright notice entry on the name table: 'Copyright 2017 The Cairo Project Authors (https://github.com/Gue3bara/Cairo)'
...
|  | /Users/Air/Google/fonts/ofl/titilliumweb/TitilliumWeb-Roman-VF.ttf |
|:--- | ---:|
| Dehinted Size | 158.4kb |
| Hinted Size | 188.3kb |
| Increase | 29.9kb |
| Change   | 18.9 % |
...
* :bread: **PASS** /Users/Air/Google/fonts/ofl/titilliumweb/TitilliumWeb-Roman-VF.ttf is named canonically.
